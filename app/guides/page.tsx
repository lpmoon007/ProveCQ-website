...
const GUIDES: { label: string; title: string; body: string; href: string; dark?: boolean }[] = [
  ...
  { label: "Methodology", title: "The 5 behavioral signals that predict value at work", body: "The first-principles science behind the CQ score.", href: "/guides/the-science-behind-cq", dark: true },
